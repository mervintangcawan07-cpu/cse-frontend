...
export default function EliminationStrategyCard({ strategy }: EliminationStrategyCardProps) {
  ...
  return (
    <div className="p-3.5 sm:p-4 bg-blue-50/80 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800/60 rounded-2xl space-y-1.5 shadow-2xs">
      ...
      <p className="text-blue-950 dark:text-blue-200 text-xs sm:text-sm leading-relaxed font-medium">
        {strategy.trim()}
      </p>
    </div>
  );
