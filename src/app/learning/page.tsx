...
export default function LearningHubPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-8">
      {/* Top Banner Header */}
      <div className="relative bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-700 text-white p-6 sm:p-8 rounded-3xl shadow-xl shadow-indigo-600/15 space-y-3 overflow-hidden">
