        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-slate-900 rounded-3xl p-8 border border-emerald-500 shadow-xl flex flex-col relative">
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-4 rounded-xl font-black bg-emerald-500 hover:bg-emerald-400 text-slate-950 transition shadow-lg disabled:opacity-50"
            >
              {loading ? "Connecting..." : "Pay ₱499 via PayMongo"}
            </button>
          </div>
        </div>
      </div>
